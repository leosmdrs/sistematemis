"""
Sistema Têmis — instrumentos de apoio à atividade correcional.

Copyright (C) 2026 Leonardo Medeiros

Este programa é software livre: você pode redistribuí-lo e/ou
modificá-lo sob os termos da Licença Pública Geral Affero GNU,
conforme publicada pela Free Software Foundation, na versão 3 ou
(a seu critério) qualquer versão posterior.

Este programa é distribuído na expectativa de ser útil, mas SEM
QUALQUER GARANTIA. Veja a Licença Pública Geral Affero GNU para
